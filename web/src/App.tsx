          ...
          <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25">
            ...
            <form className='mt-8 flex flex-col gap-4'>
              ...
              <div className='grid grid-cols-2 gap-4'>
                ...
                <div className='flex flex-col gap-2'>
                  <label htmlFor="discord">Indique seu discord</label>
                  <Input id='discord' type="text" placeholder='User#1111' />
                </div>
              </div>
              ...
              <footer className='mt-4 flex justify-end gap-4'>
                <Dialog.Close type='submit' className='bg-zinc-500 px-5 h-12 rounded-md font-semibold hover:bg-zinc-600'>Cancelar</Dialog.Close>
